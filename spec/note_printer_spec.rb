...
describe Note_printer do
  ...
  let(:first_note) { double :first_note, show_title: 'My first note', body: 'This is my first note' }
  let(:second_note) { double :second_note, show_title: 'My second note', body: 'This is my second note' }
